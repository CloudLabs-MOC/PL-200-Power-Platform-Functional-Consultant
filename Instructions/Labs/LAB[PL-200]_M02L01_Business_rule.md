...
1. In the **Objects** pane on the left, expand **Tables (1)**.

1. Select the **Resource (2)** table.

1. Under **Customizations**, select **Business rules (3)**.

    ![](../media/pl200-p9t1p1.png)
...
1. Select **+ New business rule** from the command bar.
    ...
    ![](../media/pl200-p9t1p2.png)

1. In the Business rule designer, next to the **New business rule** name at the top of the screen, select the drop-down caret.

1. Enter `Resource Type Internal` for **Business rule name (1)**. You can select on the drop-down caret **(2)** again to collapse this section.

    ![](../media/pl200-p9t1p3.png)

1. In the **Scope** drop-down in the top-right of the Business rules designer, select **All Forms**.

    ![](../media/pl200-p9t1p4.png)

1. Select the **Condition** tile in the canvas and in the **Properties** pane enter `Check Resource Type` for **Display Name (1)**. 

1. In the **Rules** section, select **Resource Type** **(2)** for **Field**, select **Equals** **(3)** for **Operator**, select **Value** **(4)** for **Type**, and select **Internal (5)** for **Value**.

1. Select **Apply** **(6)**.

    ![](../media/pl200-p9t1p5.png)

1. Select the **Components** tab.

1. Drag the **Set Visibility (1)** action and place it on the **True** side (on the right-hand side) of the condition.

1. Enter `Show User` for **Display Name (2)**.

1. In the **Visibility** section, select **User (3)** and **Yes (4)**.

1. Select **Apply (5)**.

    ![](../media/pl200-p9t1p6.png)
...
1. Select **+ Add (1)** and select **Add Set Business Required (2)** and then select the plus icon to the right of the **Hide Contact** tile.
...
1. Enter `Contact Not Required` for **Display Name**. In the **Business Required** section, select **Contact** and **Not Business Required**. Select **Apply**.
...
1. Select **Save**.
    ...
    ![](../media/pl200-p9t1p8.png)

1. Select **Activate**.

    ![](../media/pl200-p9t1p9.png)

1. You should see the message Validation successful.

1. In the **Process Activate Confirmation** dialog, select **Activate**.

    ![](../media/pl200-p9t1p10.png)

1. Select **Save As**.

    ![](../media/pl200-p9t1p11.png)

1. Next to **New business rule** name at the top of the screen, select the drop-down caret.

1. Enter `Resource Type External` **(1)** for **Business rule name**. Collapse the top section **(2)**.

    ![](../media/pl200-p9t1p12.png)

1. Select the **Check Resource Type (1)** tile.

1. In the **Rules** section, uncheck **Internal** and check **External (2)**.

1. Select **Apply (3)**.

    ![](../media/pl200-p9t1p13.png)
...
1. Select the **Contact Not Required (1)** tile.

1. Enter `Contact Required` for **Display Name (1)**, select **Business Required** for **Status (3)** and select **Apply (4)**.

    ![](../media/pl200-p9t1p14.png)
...
1. Select the **Condition** tile in the canvas and in the **Properties** pane, enter `Percentage Complete` for **Display Name (1)**.
